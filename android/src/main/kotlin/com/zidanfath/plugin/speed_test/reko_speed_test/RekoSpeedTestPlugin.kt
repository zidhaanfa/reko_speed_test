...
/** RekoSpeedTestPlugin */
class RekoSpeedTestPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        methodChannel =
            MethodChannel(flutterPluginBinding.binaryMessenger, "com.zidanfath.plugin/method")
        methodChannel.setMethodCallHandler(this)
    }

    override fun onMethodCall(call: MethodCall, result: Result) {
        print("RekoSpeedTestPlugin: onMethodCall: ${call.method}")
        this.result = result
        when (call.method) {
