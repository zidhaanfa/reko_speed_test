...
export './src/reko_speed_test.dart' show RekoSpeedTest, ResultCallback, TestProgressCallback;
export './src/reko_speed_test_platform_interface.dart' show ErrorCallback;
